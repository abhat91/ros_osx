...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/opt/ros/jade/include;/usr/local/Cellar/urdfdom_headers/0.2.3/include".split(';') if "/opt/ros/jade/include;/usr/local/Cellar/urdfdom_headers/0.2.3/include" != "" else []
