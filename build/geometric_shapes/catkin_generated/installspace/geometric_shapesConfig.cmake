...
if(NOT "include;/opt/ros/jade/include;/usr/local/Cellar/eigen/3.2.8/include/eigen3;/usr/local/Cellar/console_bridge/0.2.5/include " STREQUAL " ")
  set(geometric_shapes_INCLUDE_DIRS "")
  set(_include_dirs "include;/opt/ros/jade/include;/usr/local/Cellar/eigen/3.2.8/include/eigen3;/usr/local/Cellar/console_bridge/0.2.5/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'geometric_shapes' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/jade/${idir}'.  Ask the maintainer 'Ioan Sucan <isucan@google.com>, Dave Coleman <dave@dav.ee>' to fix it.")
    endif()
