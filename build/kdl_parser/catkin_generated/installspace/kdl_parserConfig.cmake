...
if(NOT "include;/usr/local/include;/usr/local/include/eigen3;/opt/ros/jade/include " STREQUAL " ")
  set(kdl_parser_INCLUDE_DIRS "")
  set(_include_dirs "include;/usr/local/include;/usr/local/include/eigen3;/opt/ros/jade/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kdl_parser' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/jade/${idir}'.  Ask the maintainer 'Ioan Sucan <isucan@gmail.com>, Jackie Kay <jacquelinekay1@gmail.com>' to fix it.")
    endif()
