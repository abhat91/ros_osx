...
if(NOT "include;/usr/local/Cellar/eigen/3.2.8/include/eigen3;/usr/local/include;/usr/local/include/pcl-1.8 " STREQUAL " ")
  set(pcl_conversions_INCLUDE_DIRS "")
  set(_include_dirs "include;/usr/local/Cellar/eigen/3.2.8/include/eigen3;/usr/local/include;/usr/local/include/pcl-1.8")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pcl_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/jade/${idir}'.  Ask the maintainer 'Paul Bovbel <paul@bovbel.com>, Bill Morris <bill@neautomation.com>' to fix it.")
    endif()
