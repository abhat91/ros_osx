...
if(NOT "include;/usr/local/include;/usr/local/Cellar/eigen/3.2.8/include/eigen3;/usr/local/include/pcl-1.8;/usr/local/include/vtk-7.0;/usr/include;/System/Library/Frameworks/Python.framework/Versions/2.7/include/python2.7;/usr/include/libxml2;/usr/local/Cellar/flann/1.8.4_1/include " STREQUAL " ")
  set(pcl_ros_INCLUDE_DIRS "")
  set(_include_dirs "include;/usr/local/include;/usr/local/Cellar/eigen/3.2.8/include/eigen3;/usr/local/include/pcl-1.8;/usr/local/include/vtk-7.0;/usr/include;/System/Library/Frameworks/Python.framework/Versions/2.7/include/python2.7;/usr/include/libxml2;/usr/local/Cellar/flann/1.8.4_1/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pcl_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/jade/${idir}'.  Ask the maintainer 'Paul Bovbel <paul@bovbel.com>, Bill Morris <bill@neautomation.com>' to fix it.")
    endif()
