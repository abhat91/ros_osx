...
if(NOT "include;/usr/local/Cellar/console_bridge/0.2.5/include " STREQUAL " ")
  set(rosconsole_bridge_INCLUDE_DIRS "")
  set(_include_dirs "include;/usr/local/Cellar/console_bridge/0.2.5/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosconsole_bridge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/jade/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>, Ioan Sucan <isucan@gmail.com>' to fix it.")
    endif()
