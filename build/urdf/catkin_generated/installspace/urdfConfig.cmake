...
if(NOT "include;/usr/local/Cellar/urdfdom_headers/0.2.3/include;/usr/local/Cellar/urdfdom/0.2.10/include;/usr/local/Cellar/console_bridge/0.2.5/include;/usr/local/include " STREQUAL " ")
  set(urdf_INCLUDE_DIRS "")
  set(_include_dirs "include;/usr/local/Cellar/urdfdom_headers/0.2.3/include;/usr/local/Cellar/urdfdom/0.2.10/include;/usr/local/Cellar/console_bridge/0.2.5/include;/usr/local/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'urdf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/jade/${idir}'.  Ask the maintainer 'Ioan Sucan <isucan@gmail.com>, Jackie Kay <jacquelinekay1@gmail.com>' to fix it.")
    endif()
