...
//#line 280 "/Users/adityabhat/Downloads/src/dynamic_reconfigure/src/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(EdgeDetectionConfig::AbstractParamDescriptionConstPtr(new EdgeDetectionConfig::ParamDescription<int>("edge_type", "int", 0, "Edge Detection Methods", "{'enum_description': 'An enum for Edge Detection Mehtods', 'enum': [{'srcline': 42, 'description': 'Sobel Derivatives', 'srcfile': '/Users/adityabhat/Downloads/src/vision_opencv/opencv_apps/cfg/EdgeDetection.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Sobel'}, {'srcline': 43, 'description': 'Laplace Operator', 'srcfile': '/Users/adityabhat/Downloads/src/vision_opencv/opencv_apps/cfg/EdgeDetection.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Laplace'}, {'srcline': 44, 'description': 'Canny Edge Detector', 'srcfile': '/Users/adityabhat/Downloads/src/vision_opencv/opencv_apps/cfg/EdgeDetection.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'Canny'}]}", &EdgeDetectionConfig::edge_type)));
//#line 280 "/Users/adityabhat/Downloads/src/dynamic_reconfigure/src/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(EdgeDetectionConfig::AbstractParamDescriptionConstPtr(new EdgeDetectionConfig::ParamDescription<int>("edge_type", "int", 0, "Edge Detection Methods", "{'enum_description': 'An enum for Edge Detection Mehtods', 'enum': [{'srcline': 42, 'description': 'Sobel Derivatives', 'srcfile': '/Users/adityabhat/Downloads/src/vision_opencv/opencv_apps/cfg/EdgeDetection.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Sobel'}, {'srcline': 43, 'description': 'Laplace Operator', 'srcfile': '/Users/adityabhat/Downloads/src/vision_opencv/opencv_apps/cfg/EdgeDetection.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Laplace'}, {'srcline': 44, 'description': 'Canny Edge Detector', 'srcfile': '/Users/adityabhat/Downloads/src/vision_opencv/opencv_apps/cfg/EdgeDetection.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'Canny'}]}", &EdgeDetectionConfig::edge_type)));
//#line 280 "/Users/adityabhat/Downloads/src/dynamic_reconfigure/src/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 42 "/Users/adityabhat/Downloads/src/vision_opencv/opencv_apps/cfg/EdgeDetection.cfg"
      const int EdgeDetection_Sobel = 0;
//#line 43 "/Users/adityabhat/Downloads/src/vision_opencv/opencv_apps/cfg/EdgeDetection.cfg"
      const int EdgeDetection_Laplace = 1;
//#line 44 "/Users/adityabhat/Downloads/src/vision_opencv/opencv_apps/cfg/EdgeDetection.cfg"
