...
(cl:defmethod cl:initialize-instance :after ((m <PointHeadGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PointHeadGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name control_msgs-msg:<PointHeadGoal> is deprecated: use control_msgs-msg:PointHeadGoal instead.")))
