...
if("TRUE" STREQUAL "TRUE")
  set(compressed_depth_image_transport_SOURCE_PREFIX /Users/adityabhat/Downloads/src/image_transport_plugins/compressed_depth_image_transport)
  set(compressed_depth_image_transport_DEVEL_PREFIX /Users/adityabhat/Downloads/devel)
  ...
  set(compressed_depth_image_transport_INSTALL_PREFIX /opt/ros/jade)
...
if(NOT "/Users/adityabhat/Downloads/devel/include;/Users/adityabhat/Downloads/src/image_transport_plugins/compressed_depth_image_transport/include;/usr/local/include/opencv;/usr/local/include " STREQUAL " ")
  set(compressed_depth_image_transport_INCLUDE_DIRS "")
  set(_include_dirs "/Users/adityabhat/Downloads/devel/include;/Users/adityabhat/Downloads/src/image_transport_plugins/compressed_depth_image_transport/include;/usr/local/include/opencv;/usr/local/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'compressed_depth_image_transport' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/Users/adityabhat/Downloads/src/image_transport_plugins/compressed_depth_image_transport/${idir}'.  Ask the maintainer 'David Gossow <dgossow@willowgarage.com>' to fix it.")
    endif()
    _list_append_unique(compressed_depth_image_transport_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "compressed_depth_image_transport;/usr/local/lib/libopencv_videostab.2.4.12.dylib;/usr/local/lib/libopencv_video.2.4.12.dylib;/usr/local/lib/libopencv_superres.2.4.12.dylib;/usr/local/lib/libopencv_stitching.2.4.12.dylib;/usr/local/lib/libopencv_photo.2.4.12.dylib;/usr/local/lib/libopencv_ocl.2.4.12.dylib;/usr/local/lib/libopencv_objdetect.2.4.12.dylib;/usr/local/lib/libopencv_nonfree.2.4.12.dylib;/usr/local/lib/libopencv_ml.2.4.12.dylib;/usr/local/lib/libopencv_legacy.2.4.12.dylib;/usr/local/lib/libopencv_imgproc.2.4.12.dylib;/usr/local/lib/libopencv_highgui.2.4.12.dylib;/usr/local/lib/libopencv_gpu.2.4.12.dylib;/usr/local/lib/libopencv_flann.2.4.12.dylib;/usr/local/lib/libopencv_features2d.2.4.12.dylib;/usr/local/lib/libopencv_core.2.4.12.dylib;/usr/local/lib/libopencv_contrib.2.4.12.dylib;/usr/local/lib/libopencv_calib3d.2.4.12.dylib")
