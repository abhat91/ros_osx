...
if("TRUE" STREQUAL "TRUE")
  set(eigen_conversions_SOURCE_PREFIX /Users/adityabhat/Downloads/src/geometry/eigen_conversions)
  set(eigen_conversions_DEVEL_PREFIX /Users/adityabhat/Downloads/devel)
  ...
  set(eigen_conversions_INSTALL_PREFIX /opt/ros/jade)
...
if(NOT "/Users/adityabhat/Downloads/src/geometry/eigen_conversions/include;/usr/local/Cellar/eigen/3.2.8/include/eigen3;/usr/local/include;/usr/local/include/eigen3;/opt/ros/jade/include " STREQUAL " ")
  set(eigen_conversions_INCLUDE_DIRS "")
  set(_include_dirs "/Users/adityabhat/Downloads/src/geometry/eigen_conversions/include;/usr/local/Cellar/eigen/3.2.8/include/eigen3;/usr/local/include;/usr/local/include/eigen3;/opt/ros/jade/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'eigen_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/Users/adityabhat/Downloads/src/geometry/eigen_conversions/${idir}'.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
    endif()
    _list_append_unique(eigen_conversions_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "eigen_conversions;/opt/ros/jade/lib/liborocos-kdl.1.3.0.dylib")
