...
if("TRUE" STREQUAL "TRUE")
  set(gazebo_ros_SOURCE_PREFIX /Users/adityabhat/Downloads/src/gazebo_ros_pkgs/gazebo_ros)
  set(gazebo_ros_DEVEL_PREFIX /Users/adityabhat/Downloads/devel)
  ...
  set(gazebo_ros_INSTALL_PREFIX /opt/ros/jade)
...
if(NOT "/Users/adityabhat/Downloads/devel/include;/usr/local/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/Users/adityabhat/Downloads/src/gazebo_ros_pkgs/gazebo_ros/${idir}'.  Ask the maintainer 'John Hsu <hsu@osrfoundation.org>, Dave Coleman <davetcoleman@gmail.com>' to fix it.")
    endif()
    _list_append_unique(gazebo_ros_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "gazebo_ros_api_plugin;gazebo_ros_paths_plugin;/usr/local/lib/libtinyxml.dylib")
