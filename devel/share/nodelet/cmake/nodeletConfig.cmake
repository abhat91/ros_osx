...
if("TRUE" STREQUAL "TRUE")
  set(nodelet_SOURCE_PREFIX /Users/adityabhat/Downloads/src/nodelet_core/nodelet)
  set(nodelet_DEVEL_PREFIX /Users/adityabhat/Downloads/devel)
  set(nodelet_INSTALL_PREFIX "")
  set(nodelet_PREFIX ${nodelet_DEVEL_PREFIX})
else()
  set(nodelet_SOURCE_PREFIX "")
  set(nodelet_DEVEL_PREFIX "")
  set(nodelet_INSTALL_PREFIX /opt/ros/jade)
...
if(NOT "/Users/adityabhat/Downloads/devel/include;/Users/adityabhat/Downloads/src/nodelet_core/nodelet/include;/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.11.sdk/System/Library/Frameworks/Kernel.framework/Headers/uuid;/usr/local/include " STREQUAL " ")
  set(nodelet_INCLUDE_DIRS "")
  set(_include_dirs "/Users/adityabhat/Downloads/devel/include;/Users/adityabhat/Downloads/src/nodelet_core/nodelet/include;/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.11.sdk/System/Library/Frameworks/Kernel.framework/Headers/uuid;/usr/local/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'nodelet' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/Users/adityabhat/Downloads/src/nodelet_core/nodelet/${idir}'.  Ask the maintainer 'Esteve Fernandez <esteve@osrfoundation.org>' to fix it.")
    endif()
...
set(nodelet_EXPORTED_TARGETS "nodelet_generate_messages_cpp;nodelet_generate_messages_eus;nodelet_generate_messages_lisp;nodelet_generate_messages_py")
