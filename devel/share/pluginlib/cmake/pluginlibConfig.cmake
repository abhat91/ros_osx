...
if("TRUE" STREQUAL "TRUE")
  set(pluginlib_SOURCE_PREFIX /Users/adityabhat/Downloads/src/pluginlib)
  set(pluginlib_DEVEL_PREFIX /Users/adityabhat/Downloads/devel)
  ...
  set(pluginlib_INSTALL_PREFIX /opt/ros/jade)
...
if(NOT "/Users/adityabhat/Downloads/src/pluginlib/include;/usr/local/include " STREQUAL " ")
  set(pluginlib_INCLUDE_DIRS "")
  set(_include_dirs "/Users/adityabhat/Downloads/src/pluginlib/include;/usr/local/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pluginlib' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/Users/adityabhat/Downloads/src/pluginlib/${idir}'.  Ask the maintainer 'Esteve Fernandez <esteve@osrfoundation.org>' to fix it.")
    endif()
    _list_append_unique(pluginlib_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "/usr/local/lib/libboost_filesystem-mt.dylib;/usr/local/lib/libboost_system-mt.dylib;/usr/local/lib/libtinyxml.dylib")
