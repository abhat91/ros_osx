...
if("TRUE" STREQUAL "TRUE")
  set(rosconsole_SOURCE_PREFIX /Users/adityabhat/Downloads/src/ros_comm/rosconsole)
  set(rosconsole_DEVEL_PREFIX /Users/adityabhat/Downloads/devel)
  ...
  set(rosconsole_INSTALL_PREFIX /opt/ros/jade)
...
if(NOT "/Users/adityabhat/Downloads/src/ros_comm/rosconsole/include;/usr/local/include " STREQUAL " ")
  set(rosconsole_INCLUDE_DIRS "")
  set(_include_dirs "/Users/adityabhat/Downloads/src/ros_comm/rosconsole/include;/usr/local/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosconsole' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/Users/adityabhat/Downloads/src/ros_comm/rosconsole/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
    _list_append_unique(rosconsole_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "rosconsole;rosconsole_print;rosconsole_backend_interface;/usr/local/lib/libboost_regex-mt.dylib;/usr/local/lib/libboost_system-mt.dylib;/usr/local/lib/libboost_thread-mt.dylib;/usr/local/lib/libboost_chrono-mt.dylib;/usr/local/lib/libboost_date_time-mt.dylib;/usr/local/lib/libboost_atomic-mt.dylib")
