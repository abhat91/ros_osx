...
if("TRUE" STREQUAL "TRUE")
  set(stereo_image_proc_SOURCE_PREFIX /Users/adityabhat/Downloads/src/image_pipeline/stereo_image_proc)
  set(stereo_image_proc_DEVEL_PREFIX /Users/adityabhat/Downloads/devel)
  ...
  set(stereo_image_proc_INSTALL_PREFIX /opt/ros/jade)
...
if(NOT "/Users/adityabhat/Downloads/devel/include;/Users/adityabhat/Downloads/src/image_pipeline/stereo_image_proc/include " STREQUAL " ")
  set(stereo_image_proc_INCLUDE_DIRS "")
  set(_include_dirs "/Users/adityabhat/Downloads/devel/include;/Users/adityabhat/Downloads/src/image_pipeline/stereo_image_proc/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'stereo_image_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/Users/adityabhat/Downloads/src/image_pipeline/stereo_image_proc/${idir}'.  Ask the maintainer 'Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
    endif()
