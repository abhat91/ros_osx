...
if("TRUE" STREQUAL "TRUE")
  set(tf2_SOURCE_PREFIX /Users/adityabhat/Downloads/src/geometry_experimental/tf2)
  set(tf2_DEVEL_PREFIX /Users/adityabhat/Downloads/devel)
  set(tf2_INSTALL_PREFIX "")
  set(tf2_PREFIX ${tf2_DEVEL_PREFIX})
else()
  set(tf2_SOURCE_PREFIX "")
  set(tf2_DEVEL_PREFIX "")
  set(tf2_INSTALL_PREFIX /opt/ros/jade)
...
if(NOT "/Users/adityabhat/Downloads/src/geometry_experimental/tf2/include;/usr/local/Cellar/console_bridge/0.2.5/include " STREQUAL " ")
  set(tf2_INCLUDE_DIRS "")
  set(_include_dirs "/Users/adityabhat/Downloads/src/geometry_experimental/tf2/include;/usr/local/Cellar/console_bridge/0.2.5/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tf2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/Users/adityabhat/Downloads/src/geometry_experimental/tf2/${idir}'.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
    endif()
    _list_append_unique(tf2_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "tf2;/usr/local/lib/libconsole_bridge.dylib")
