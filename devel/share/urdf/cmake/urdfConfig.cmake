...
if("TRUE" STREQUAL "TRUE")
  set(urdf_SOURCE_PREFIX /Users/adityabhat/Downloads/src/robot_model/urdf)
  set(urdf_DEVEL_PREFIX /Users/adityabhat/Downloads/devel)
  set(urdf_INSTALL_PREFIX "")
  set(urdf_PREFIX ${urdf_DEVEL_PREFIX})
else()
  set(urdf_SOURCE_PREFIX "")
  set(urdf_DEVEL_PREFIX "")
  set(urdf_INSTALL_PREFIX /opt/ros/jade)
...
if(NOT "/Users/adityabhat/Downloads/src/robot_model/urdf/include;/usr/local/Cellar/urdfdom_headers/0.2.3/include;/usr/local/Cellar/urdfdom/0.2.10/include;/usr/local/Cellar/console_bridge/0.2.5/include;/usr/local/include " STREQUAL " ")
  set(urdf_INCLUDE_DIRS "")
  set(_include_dirs "/Users/adityabhat/Downloads/src/robot_model/urdf/include;/usr/local/Cellar/urdfdom_headers/0.2.3/include;/usr/local/Cellar/urdfdom/0.2.10/include;/usr/local/Cellar/console_bridge/0.2.5/include;/usr/local/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'urdf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/Users/adityabhat/Downloads/src/robot_model/urdf/${idir}'.  Ask the maintainer 'Ioan Sucan <isucan@gmail.com>, Jackie Kay <jacquelinekay1@gmail.com>' to fix it.")
    endif()
    _list_append_unique(urdf_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "urdf;/usr/local/Cellar/urdfdom/0.2.10/lib/liburdfdom_sensor.dylib;/usr/local/Cellar/urdfdom/0.2.10/lib/liburdfdom_model_state.dylib;/usr/local/Cellar/urdfdom/0.2.10/lib/liburdfdom_model.dylib;/usr/local/Cellar/urdfdom/0.2.10/lib/liburdfdom_world.dylib;/usr/local/lib/libconsole_bridge.dylib;/usr/local/lib/libboost_thread-mt.dylib;/usr/local/lib/libboost_chrono-mt.dylib;/usr/local/lib/libboost_system-mt.dylib;/usr/local/lib/libboost_date_time-mt.dylib;/usr/local/lib/libboost_atomic-mt.dylib")
